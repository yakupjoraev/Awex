      ...
      <div className="sidebar__inner">
        <div className="sidebar__header">
          <NavLink className="sidebar__logo" to={ROUTE.HOME_PAGE_PATH}>
            <picture>
              <source media="(max-width: 992px)" srcSet="/img/sidebar/logo-mobile.svg" />
              <img className="sidebar__logo-img" src="/img/sidebar/logo.svg" alt="logo" />
            </picture>
          </NavLink>

          <div className="sidebar__themes">
            <div className="sidebar__user" data-select-wrapper="" ref={menuRef}>
              <img className={classNames("sidebar__user-icon", { active: userMenuOpened, })} src="/img/sidebar/user-black.svg" alt="user" data-select-arrow="" onClick={handleMenuIconClick} />
              <div className={classNames("sidebar__user-list select-list", { active: userMenuOpened, })} data-select-list="" >
                <NavLink className="sidebar__user-item select-item" to={ROUTE.SETTINGS_PATH}
                  onClick={handleMenuItemClick}
                >
                  <img className="sidebar__user-item-img" src="/img/sidebar/user.svg" alt="user" />
                  <span className="sidebar__user-item-text">{ props.userName }</span>
                </NavLink>

                <NavLink className="sidebar__user-item select-item" to={ROUTE.SETTINGS_PATH}
                  onClick={handleMenuItemClick}
                >
                  <img className="sidebar__user-item-img" src="/img/sidebar/settings.svg" alt="settings" />
                  <span className="sidebar__user-item-text">Настройки</span>
                </NavLink>

                <div className="sidebar__user-item sidebar__user-item--red select-item"
                  onClick={() => {
                    handleMenuItemClick();
                    props.onLogout();
                  }}
                >
                  <img className="sidebar__user-item-img" src="/img/sidebar/log-out.svg" alt="log-out" />
        ...
        <div className="sidebar__menu">
          <ul className="sidebar__menu-list">
            <li className="sidebar__menu-item">
              <NavLink to={ROUTE.HOME_PAGE_PATH} className="sidebar__menu-link">
                <span className="sidebar__menu-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 21.75H13.75V16.5C13.75 15.535 12.965 14.75 12 14.75C11.035 14.75 10.25 15.535 10.25 16.5V21.75H6C3.582 21.75 2.25 20.418 2.25 18V11.65C2.25 9.52704 2.83599 8.93401 3.79199 8.14101L9.91199 3.01003C11.121 1.99503 12.879 1.99503 14.088 3.01003L20.208 8.14101C21.164 8.93401 21.75 9.52804 21.75 11.65V18C21.75 20.418 20.418 21.75 18 21.75ZM15.25 20.25H18C19.577 20.25 20.25 19.577 20.25 18V11.65C20.25 10.124 19.998 9.91506 19.251 9.29506L13.125 4.15908C12.473 3.61308 11.527 3.61308 10.875 4.15908L4.74902 9.29506C4.00202 9.91506 3.75 10.124 3.75 11.65V18C3.75 19.577 4.423 20.25 6 20.25H8.75V16.5C8.75 14.708 10.208 13.25 12 13.25C13.792 13.25 15.25 14.708 15.25 16.5V20.25Z" fill="#6F6F6F"></path>
                  </svg>
                </span>
            ...
            <li className="sidebar__menu-item">
              <NavLink className="sidebar__menu-link" to={ROUTE.DEPOSITS_PATH}>
                <span className="sidebar__menu-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 2.25H8C5.582 2.25 4.25 3.582 4.25 6V21C4.25 21.268 4.39302 21.5149 4.62402 21.6479C4.74002 21.716 4.87 21.75 5 21.75C5.128 21.75 5.25707 21.717 5.37207 21.651L12 17.863L18.6279 21.65C18.8599 21.783 19.146 21.782 19.376 21.647C19.607 21.513 19.75 21.266 19.75 20.999V5.99902C19.75 3.58202 18.418 2.25 16 2.25ZM18.25 19.707L12.3721 16.349C12.1421 16.217 11.8579 16.217 11.6279 16.349L5.75 19.708V6C5.75 4.423 6.423 3.75 8 3.75H16C17.577 3.75 18.25 4.423 18.25 6V19.707ZM15.75 8C15.75 8.414 15.414 8.75 15 8.75H9C8.586 8.75 8.25 8.414 8.25 8C8.25 7.586 8.586 7.25 9 7.25H15C15.414 7.25 15.75 7.586 15.75 8Z" fill="#6F6F6F"></path>
                  </svg>
                </span>
            ...
            <li className={classNames("sidebar__menu-item", { show: projectsMenuOpened, })}>
              <div className="sidebar__menu-item-main">
                <NavLink className="sidebar__menu-link" to={ROUTE.PROJECTS_PATH} end>
                  <span className="sidebar__menu-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M16 7H3C2.448 7 2 6.552 2 6C2 5.448 2.448 5 3 5H16C16.552 5 17 5.448 17 6C17 6.552 16.552 7 16 7Z" fill="#6F6F6F"></path>
                      <path d="M21 13H3C2.448 13 2 12.552 2 12C2 11.448 2.448 11 3 11H21C21.552 11 22 11.448 22 12C22 12.552 21.552 13 21 13Z" fill="#6F6F6F"></path>
                      <path d="M12 19H3C2.448 19 2 18.552 2 18C2 17.448 2.448 17 3 17H12C12.552 17 13 17.448 13 18C13 18.552 12.552 19 12 19Z" fill="#6F6F6F"></path>
                    </svg>
                  </span>
                  <span className="sidebar__menu-name">Мои проекты</span>
                </NavLink>

                <img className="sidebar__menu-arrow" src="/img/sidebar/arrow.svg" alt="arrow"
              ...
              <ul className="sidebar__menu-sublist">
                <li className="sidebar__menu-subitem">
                  <NavLink className="sidebar__menu-sublink" to={ROUTE.PROJECTS_NEW_PROJECT_PATH}>
                    Добавить проект
                  </NavLink>
                </li>
            ...
            <li className="sidebar__menu-item">
              ...
              <ul className="sidebar__menu-sublist">
                <li className="sidebar__menu-subitem">
                  <NavLink className="sidebar__menu-sublink" to={ROUTE.INTEGRATION_API_PATH}>
                    API
                  </NavLink>
                </li>

                <li className="sidebar__menu-subitem">
                  <NavLink className="sidebar__menu-sublink" to={ROUTE.INTEGRATION_CMS_MODULE_PATH}>
                    Модули CMS
                  </NavLink>
                </li>

                <li className="sidebar__menu-subitem">
                  <NavLink className="sidebar__menu-sublink" to={ROUTE.INTEGRATION_HTML_WIDJET_PATH}>
                    HTML-виджет
                  </NavLink>
                </li>
              </ul>
            ...
            <li className="sidebar__menu-item">
              <NavLink className="sidebar__menu-link" to={ROUTE.INFOCENTER_PATH}>
                <span className="sidebar__menu-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.0049 21.749C3.5479 21.749 3.10408 21.569 2.76809 21.233C2.29408 20.76 2.13108 20.073 2.34108 19.441L3.1819 16.94C3.2799 16.633 3.27102 16.325 3.15602 16.082C2.56402 14.809 2.25392 13.399 2.25392 11.999C2.25392 6.62402 6.62697 2.25 12.002 2.25C17.378 2.25 21.751 6.62302 21.751 11.999C21.751 17.375 17.378 21.748 12.002 21.748C10.603 21.748 9.19302 21.437 7.92702 20.848C7.67902 20.729 7.37002 20.721 7.05202 20.822L4.56301 21.658C4.37801 21.719 4.1899 21.749 4.0049 21.749ZM12.001 3.75C7.453 3.75 3.75295 7.45002 3.75295 11.999C3.75295 13.182 4.01596 14.373 4.51296 15.443C4.78896 16.024 4.82493 16.723 4.60793 17.406L3.76393 19.917C3.72193 20.042 3.7859 20.131 3.8279 20.173C3.8699 20.215 3.95998 20.279 4.08498 20.237L6.58303 19.398C7.27703 19.177 7.97696 19.211 8.56496 19.492C9.62696 19.986 10.818 20.249 12.001 20.249C16.55 20.249 20.25 16.549 20.25 12C20.25 7.451 16.55 3.75 12.001 3.75ZM12.0049 13C11.4529 13 11 12.552 11 12C11 11.448 11.4431 11 11.9951 11H12.0049C12.5579 11 13.0049 11.448 13.0049 12C13.0049 12.552 12.5579 13 12.0049 13ZM17.0049 12C17.0049 11.448 16.5579 11 16.0049 11H15.9951C15.4431 11 15 11.448 15 12C15 12.552 15.4529 13 16.0049 13C16.5579 13 17.0049 12.552 17.0049 12ZM9.0049 12C9.0049 11.448 8.5579 11 8.0049 11H7.99514C7.44314 11 7.00002 11.448 7.00002 12C7.00002 12.552 7.4529 13 8.0049 13C8.5579 13 9.0049 12.552 9.0049 12Z" fill="#6F6F6F"></path>
                  </svg>
                </span>
