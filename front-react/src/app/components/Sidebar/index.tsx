    ...
    <aside className="sidebar">
      <div className="sidebar__inner">
        <div className="sidebar__header">
          <Link className="sidebar__logo" to={HOME_PAGE_PATH}>
            <picture>
          ...
          <div className="sidebar__themes">
            <div className="sidebar__user" data-select-wrapper="" ref={menuRef}>
              <img className={classNames("sidebar__user-icon", { active: userMenuOpened, })} src="/img/sidebar/user-black.svg" alt="user" data-select-arrow=""
              ...
              <div className={classNames("sidebar__user-list select-list", { active: userMenuOpened, })} data-select-list="" >
                ...
                <Link className="sidebar__user-item select-item" data-select-item=""
                  to="/settings"
                  onClick={handleMenuItemClick}
                >
                ...
                <div className="sidebar__user-item sidebar__user-item--red select-item" data-select-item=""
                  onClick={() => {
                    handleMenuItemClick();
                    props.onLogout();
                  }}
                >
                  <img className="sidebar__user-item-img"
        ...
        <div className="sidebar__menu">
          <ul className="sidebar__menu-list">
            <li className="sidebar__menu-item">
              <NavLink to={HOME_PAGE_PATH} className="sidebar__menu-link">
            ...
            <li className="sidebar__menu-item">
              <NavLink className="sidebar__menu-link" to="/deposits">
                <span className="sidebar__menu-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className={classNames("sidebar__menu-item", { show: projectsMenuOpened, })} data-menu-item="">
              <div className="sidebar__menu-item-main">
                ...
                <img className="sidebar__menu-arrow"
              ...
              <ul className="sidebar__menu-sublist" data-menu-list="">
                <li className="sidebar__menu-subitem" data-menu-item="">
                  <NavLink className="sidebar__menu-sublink"
            ...
            <li className="sidebar__menu-item">
              <NavLink className="sidebar__menu-link" to="/history">
                <span className="sidebar__menu-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
