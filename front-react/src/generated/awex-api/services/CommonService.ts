...
export class CommonService {
  ...
  public static registration(requestBody: {
    password: string;
    email: string;
    referralCode?: string;
  }): CancelablePromise<{
  ...
  public static passwordStrength(requestBody: {
    password: string;
  }): CancelablePromise<{
    score?: number;
    strength?: string;
  ...
  public static confirm(requestBody: { code: string }): CancelablePromise<{
    message?: string;
  }> {
    return __request(OpenAPI, {
      method: "POST",
  ...
  public static resend(requestBody: { email: string }): CancelablePromise<{
    message?: string;
  }> {
    return __request(OpenAPI, {
      method: "POST",
  ...
  public static send(requestBody: { email: string }): CancelablePromise<{
    message?: string;
  }> {
    return __request(OpenAPI, {
      method: "POST",
  ...
  public static resetConfirm(requestBody: { code: string }): CancelablePromise<{
    resetToken?: string;
    message?: string;
  }> {
    return __request(OpenAPI, {
  ...
  public static passwordReset(requestBody: {
    resetToken: string;
    password: string;
  }): CancelablePromise<{
    message?: string;
  ...
  public static teamMembershipConfirmation(requestBody: {
    code: string;
  }): CancelablePromise<{
    message?: string;
  }> {
  ...
  public static orderPaymentGet(uniqueId: string): CancelablePromise<{
    amount?: number;
  ...
  public static paymentCurrencies(amount?: string): CancelablePromise<{
    currencies?: Array<{
      currency: string;
      name: string;
      rate: string;
